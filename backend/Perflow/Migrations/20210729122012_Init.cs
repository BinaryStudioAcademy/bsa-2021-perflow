    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistReactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArtistReactions_Users_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ArtistReactions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasCensorship = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowNewReleases = table.Column<bool>(type: "bit", nullable: false),
                    ShowFriendsPlaying = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumReactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AlbumReactions_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumReactions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaylistReactions", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PlaylistReactions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumReactions_AlbumId",
                table: "AlbumReactions",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_AlbumReactions_UserId",
                table: "AlbumReactions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistReactions_ArtistId",
                table: "ArtistReactions",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtistReactions_UserId",
                table: "ArtistReactions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaylistReactions_PlaylistId",
                table: "PlaylistReactions",
                column: "PlaylistId");

            migrationBuilder.CreateIndex(
                name: "IX_PlaylistReactions_UserId",
                table: "PlaylistReactions",
                column: "UserId");
