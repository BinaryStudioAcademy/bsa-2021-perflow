...
namespace Perflow.Migrations
{
    ...
    [Migration("20210906221629_RemoveColorFromTagAndUpdatePageContainer")]
    partial class RemoveColorFromTagAndUpdatePageContainer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Perflow.Domain.SongTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Perflow.Domain.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Perflow.Domain.SongTag", b =>
                {
                    ...
                    b.HasOne("Perflow.Domain.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
