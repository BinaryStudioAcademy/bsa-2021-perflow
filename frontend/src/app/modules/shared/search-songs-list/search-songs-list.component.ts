...
@Component({
  selector: 'app-search-songs-list',
  templateUrl: './search-songs-list.component.html',
  styleUrls: ['./search-songs-list.component.sass']
})
export class SearchSongsListComponent implements OnInit, OnDestroy {
